###################################################################
#			Estudiantes:Luigi Quero c.i. 30.009.785			      #
#                       Sebastian Piñango c.i. 29.947.488         #
###################################################################

#################################################################################
# Las diferencias fundamentales entre este ejemplo y el presentado en           #
# el libro radican en que aquí se emplean encabezados que anticipan             #
# los datos a utilizar y sus respectivas direcciones. Además, en este ejemplo   #
# se utilizan procedimientos del sistema que permiten la lectura, impresión en  #
# pantalla y finalización de la ejecución del programa principal. Para que el   #
# ejemplo del libro sea un programa funcional,                                  #
# es necesario incluir estas características.                                   #
# El ejemplo del libro se considera un "Ejemplo Academico" pues al ser un       #
# ejemplo en papel este no necesita hacer estos pasos de inicializacion de      #
# los registros y sus direcciones ni enviar salida por pantalla ni entrada      #
#################################################################################
